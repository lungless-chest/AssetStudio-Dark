...
namespace AssetStudioGUI
{
    partial class AssetStudioGUIForm : Form
    {
        ...
        public AssetStudioGUIForm()
        {
            ...
            ApplyDarkTheme(); // Apply dark mode permanently
        ...
        {
            // Set dark background for the main form
            this.BackColor = System.Drawing.Color.FromArgb(30, 30, 30);  // Dark gray background
        ...
        // Recursive function to apply dark theme to nested controls
        private void ApplyDarkThemeToControl(Control control)
        {
            control.BackColor = System.Drawing.Color.FromArgb(45, 45, 45);  // Slightly lighter gray
            control.ForeColor = System.Drawing.Color.White;

            if (control is Panel || control is GroupBox || control is TabPage)
            {
                control.BackColor = System.Drawing.Color.FromArgb(40, 40, 40); // Slightly different shade for contrast
            }
            ...
            {
                treeView.BackColor = System.Drawing.Color.FromArgb(35, 35, 35);
                treeView.ForeColor = System.Drawing.Color.White;
            }

            // Apply to child controls (nested elements)
